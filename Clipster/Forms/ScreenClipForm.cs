...
{
    public partial class ScreenClipForm : Form
    {
        ...
        public Point CurrentTopLeft = new Point(int.MinValue, int.MinValue);
        public Point CurrentBottomRight = new Point(Int32.MaxValue, int.MaxValue);
        ...
        public Clipster InstanceRef
        {
            get;
            set;
        }

        public ScreenClipForm()
        {
            InitializeComponent();
        ...
        public void SaveSelection(bool showCursor)
        {
            ...
            if (!InstanceRef.SaveToClipBoard)
            {
                SaveFileDialog saveFileDialog1 = new SaveFileDialog
                {
                    DefaultExt = "png",
                    Filter =
                        "bmp files (*.bmp)|*.bmp|jpg files (*.jpg)|*.jpg|gif files (*.gif)|*.gif|tiff files (*.tiff)|*.tiff|png files (*.png)|*.png",
            ...
            if (ScreenPath != "" || InstanceRef.SaveToClipBoard)
            {
                ...
                ScreenShot.CaptureImage(showCursor, curSize, curPos, StartPoint, Point.Empty, bounds, ScreenPath, fi, InstanceRef.SaveToClipBoard);
        ...
        private void DragSelection()
        {
            ...
            else if (Cursor.Position.X - DragClickRelative.X > 0)
            {
            ...
            else if (Cursor.Position.Y - DragClickRelative.Y > 0)
            {
        ...
        private void ScreenClipForm_Load(object sender, EventArgs e)
        {
            int height = 0;
            int width = 0;
